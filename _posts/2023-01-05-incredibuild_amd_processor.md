...
date: '2023-01-05T00:42:28+08:00'
author: shane
layout: article
guid: 'https://yaozhixiang.com/?p=139'
permalink: /2023/01/incredibuild_amd_processor/
categories:
    - 未分类
---
...
3. Incredibuild 最近提供了一个Free License申请，不同限时的Free Trail，这个是永久免费的。可以参考[这里](https://www.incredibuild.com/pricing)申请。虽然只能支持2个Agent，以及最多16个核作为Helper，但目前这个情况对家用是基本够用的。也可以暂时不用折腾FastBuild，UE对IB的支持比FastBuild好很多。
